...
public class MainActivity extends AppCompatActivity
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        fragment.setArguments(bundle);
        adapter.addFragment(fragment, getString(R.string.item_9));
        fragment = new ImageListFragment();
        bundle = new Bundle();
        bundle.putInt("type", 10);
        fragment.setArguments(bundle);
        adapter.addFragment(fragment, getString(R.string.item_10));
        fragment = new ImageListFragment();
        bundle = new Bundle();
        bundle.putInt("type", 11);
        fragment.setArguments(bundle);
        adapter.addFragment(fragment, getString(R.string.item_11));
        fragment = new ImageListFragment();
        bundle = new Bundle();
        bundle.putInt("type", 12);
        fragment.setArguments(bundle);
        adapter.addFragment(fragment, getString(R.string.item_12));
        fragment = new ImageListFragment();
        bundle = new Bundle();
        bundle.putInt("type", 13);
        fragment.setArguments(bundle);
        adapter.addFragment(fragment, getString(R.string.item_13));
        fragment = new ImageListFragment();
        bundle = new Bundle();
        bundle.putInt("type", 14);
        fragment.setArguments(bundle);
        adapter.addFragment(fragment, getString(R.string.item_14));
        fragment = new ImageListFragment();
        bundle = new Bundle();
        bundle.putInt("type", 15);
        fragment.setArguments(bundle);
        adapter.addFragment(fragment, getString(R.string.item_15));
        fragment = new ImageListFragment();
        bundle = new Bundle();
        bundle.putInt("type", 16);
        fragment.setArguments(bundle);
        adapter.addFragment(fragment, getString(R.string.item_16));
